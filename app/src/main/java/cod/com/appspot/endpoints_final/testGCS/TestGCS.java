...
public class TestGCS extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * <pre>
   *   {@code TestGCS testGCS = new TestGCS(...);}
   *   {@code TestGCS.Check.List request = testGCS.check().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Check {
     ...
     *
     * @param content the {@link cod.com.appspot.endpoints_final.testGCS.model.MainArtistRequestMessage}
     * @return the request
     */
    public Checklogin checklogin(cod.com.appspot.endpoints_final.testGCS.model.MainArtistRequestMessage content) throws java.io.IOException {
      Checklogin result = new Checklogin(content);
      initialize(result);
      return result;
    }

    public class Checklogin extends TestGCSRequest<cod.com.appspot.endpoints_final.testGCS.model.MainDefaultResponseMessage> {
       ...
       *
       * This request holds the parameters needed by the the testGCS server.  After setting any optional
       * parameters, call the {@link Checklogin#execute()} method to invoke the remote operation. <p>
       * {@link
       ...
       * @since 1.13
       */
      protected Checklogin(cod.com.appspot.endpoints_final.testGCS.model.MainArtistRequestMessage content) {
  ...
  public class Registration {
     ...
     *
     * @param content the {@link cod.com.appspot.endpoints_final.testGCS.model.MainArtistInfoMessage}
     * @return the request
     */
    public Registerartist registerartist(cod.com.appspot.endpoints_final.testGCS.model.MainArtistInfoMessage content) throws java.io.IOException {
    ...
    public class Registerartist extends TestGCSRequest<cod.com.appspot.endpoints_final.testGCS.model.MainDefaultResponseMessage> {
       ...
       * @since 1.13
       */
      protected Registerartist(cod.com.appspot.endpoints_final.testGCS.model.MainArtistInfoMessage content) {
        super(TestGCS.this, "POST", REST_PATH, content, cod.com.appspot.endpoints_final.testGCS.model.MainDefaultResponseMessage.class);
      }
